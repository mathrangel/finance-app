<template>
  <div>
    ...
    <AppFooterInitial v-if="false"></AppFooterInitial>
  </div>
</template>

<script>
import AppHeaderInitial from '../../components/Header/header_initial.vue'
import AppFooterInitial from '../../components/Footer/footer_initial.vue'
